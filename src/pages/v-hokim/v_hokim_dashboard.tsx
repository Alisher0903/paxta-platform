            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 select-none">
                ...
                <div className={active === 'active' ? "flex justify-between px-10 gap-5 md:border-2 rounded-md border-[#6A9C89]" : "flex justify-between px-10 gap-5 md:border-2 rounded-md border-[#9a1e1eb7]"} >
                    <div
                        ...
                        className={active === 'active' ? 'text-[#6A9C89]   cursor-pointer select-none underline' : 'text-[#8f8f8f]  cursor-pointer select-none'}
                    >
                        Ishlayotgan
                    </div>
                    /
                    ...
                    {response && response?.body?.length > 0 ? (
                        response?.body.map((item: {
                            ...
                            <div className='shadow-3 rounded-3xl' key={item.districtId}
                                ...
                                <Card
                                    className={active === 'active' ? 'w-[100%] text-[#fff] bg-[#6A9C89] hover:bg-[#6A9C89cf] cursor-pointer' : ' w-[100%] bg-[#ffeaea] hover:bg-[#fffafa] cursor-pointer'}
                                >
